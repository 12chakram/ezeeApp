...
//			return user.get(0);
	...
	public TEAUIBussinessDashboardDTO getDashboardApptDetails(long bid)
	{
		...
		Query q1 = em.createQuery(queryString1.toString());
		...
		for(Appointment apntObj: appointmentObj)
		{
			...
			Query q4 = em.createQuery(queryString4.toString());
			q4.setMaxResults(1);
			...
			Query q5 = em.createQuery(queryString5.toString());
			q5.setMaxResults(1);
		...
		Query q6 = em.createQuery(queryString6.toString());
		...
		for (Staff staff : staffList)
		{
			...
			Query q7 = em.createQuery(queryString7.toString());
			...
			for (ServiceAndStaffXREF serviceAndStaffXREF : srveStaffList)
			{
				...
				Query q8 = em.createQuery(queryString8.toString());
				List<Appointment> a=q8.getResultList();
				k=k+a.size();
				Query q9 = em.createQuery("select s from Service s where s.id=:id");
	...
	public int getPendingAptcount(long id)
	{
		...
		Query q = em.createQuery(queryString1.toString());
